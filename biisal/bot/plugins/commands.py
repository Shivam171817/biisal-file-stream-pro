...
ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : <a href='https://t.me/RS_Movie'>𝐑𝐀𝐒 𝐌𝐎𝐕𝐈𝐄</a></b>"""
...
async def start(b, m):
    ...
    if Var.UPDATES_CHANNEL != "None":
        try:
            ...
            await b.send_message(
                chat_id=m.chat.id,
                text="<b>sᴏᴍᴇᴛʜɪɴɢ ᴡᴇɴᴛ ᴡʀᴏɴɢ.ᴘʟᴇᴀsᴇ <a href='https://t.me/RAS_UPDATE'>ᴄʟɪᴄᴋ ʜᴇʀᴇ ғᴏʀ sᴜᴘᴘᴏʀᴛ</a></b>",
...
async def cb_handler(client, query):
    ...
    if data == "start":
        ...
        await query.message.edit_caption(
            caption=f"<b>Mʏ ɴᴀᴍᴇ :<a href='https://t.me/RAS_file2link_bot'>{bot_name}</a>\nAᴅᴍɪɴ : <a href='https://t.me/RS_Movie'>𝐑𝐀𝐒 𝐌𝐎𝐕𝐈𝐄</a>\nʜᴏsᴛᴇᴅ ᴏɴ : ʜᴇʀᴏᴋᴜ\nᴅᴀᴛᴀʙᴀsᴇ : ᴍᴏɴɢᴏ ᴅʙ\nʟᴀɴɢᴜᴀɢᴇ : ᴘʏᴛʜᴏɴ 3</b>",
            reply_markup=InlineKeyboardMarkup(
                [[ 
                     InlineKeyboardButton("ʜᴏᴍᴇ", callback_data="start"),
...
[[ 
        ...
        await query.message.edit_caption(
            caption=f"<b>ᴊᴀɪ sʜʀᴇᴇ ᴋʀɪsʜɴᴀ ᴅᴇᴀʀ...\nɪᴍ <a href='https://t.me/RS_Movie'>𝐑𝐀𝐒 𝐌𝐎𝐕𝐈𝐄</a>\nɪ ᴀᴍ ᴛʜᴇ ᴀᴅᴍɪɴ ᴏғ ᴛʜɪs ʙᴏᴛ..ᴀɴᴅ ɪ ᴍᴀᴅᴇ ᴛʜᴇ  ʙᴏᴛ ʙʏ ʜᴇʟᴘ ᴏғ <a href='https://t.me/RS_Movie'>𝐑𝐀𝐒 𝐌𝐎𝐕𝐈𝐄</a> ʙʀᴏ..\n\nOWNER : <a href='https://t.me/RS_Movie'>𝐑𝐀𝐒 𝐌𝐎𝐕𝐈𝐄</a></b>",
            reply_markup=InlineKeyboardMarkup(
                [[ 
                     InlineKeyboardButton("ʜᴏᴍᴇ", callback_data="start"),
                     InlineKeyboardButton("ᴄʟᴏsᴇ ‼️", callback_data="close_data")
